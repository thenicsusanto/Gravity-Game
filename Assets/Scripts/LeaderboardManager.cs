...
namespace Dan.Demo
{
    public class LeaderboardManager : MonoBehaviour
    {
        ...
        public void Load()
        {
            ...
            Leaderboards.AstroSword.GetEntries(searchQuery, OnLeaderboardLoaded, ErrorCallback);
        ...
        public void Submit()
        {
            Leaderboards.AstroSword.UploadNewEntry(_playerUsernameInput.text, _playerScore, Callback, ErrorCallback);
        }

        public void DeleteEntry()
        {
            Leaderboards.AstroSword.DeleteEntry(Callback, ErrorCallback);
        }
        ...
        {
            Leaderboards.AstroSword.GetPersonalEntry(OnPersonalEntryLoaded, ErrorCallback);
        }
